...
const captcha = {
  enabled: 'on',
  apiKey: 'h4rdyy1-3df4589e-989e--3128-93ab9d414b21',
}
...
const applicants = [
  {
    ...
    mail: '@gmail.com',
    password: 'hiiollyhjk',
    profilePhotoId: '2e238589-73a0-45ce-82e5-d232b3',
    applicantCount: 1,
    category: 'normal', // n | normal, pm | premium, pt | primetime
    location: 'casablanca',
    visa: 'std', // sch, std, famr, nat, work, c1, c2, c3
  },
]
